...
export class MainMenu extends Scene
{
    ...
    create ()
    {
        ...
        // Title
        this.add.text(width / 2, height * 0.28, 'SAMURAI', {
            fontFamily: 'Arial Black', fontSize: 72, color: '#4fc3f7',
            stroke: '#000033', strokeThickness: 8
        }).setOrigin(0.5);

        this.add.text(width / 2, height * 0.42, 'SLAM', {
            fontFamily: 'Arial Black', fontSize: 72, color: '#80deea',
            stroke: '#000033', strokeThickness: 8
        }).setOrigin(0.5);

        // Subtitle
        this.add.text(width / 2, height * 0.56, 'A ROGUELIKE ADVENTURE', {
            fontFamily: 'Arial', fontSize: 18, color: '#546e7a'
        }).setOrigin(0.5);
        ...
        const startBtn = this.add.text(width / 2, height * 0.67, 'START GAME', {
        ...
        // Controls hint
        this.add.text(width / 2, height * 0.82, 'WASD / Arrows: Move    F: Melee    Click: Shoot', {
            fontFamily: 'Arial', fontSize: 14, color: '#546e7a'
        }).setOrigin(0.5);
